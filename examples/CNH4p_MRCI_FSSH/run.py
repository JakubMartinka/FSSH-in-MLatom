...
col = ml.models.methods(program='columbus', command_line_arguments=['-m', '1700'], directory_with_input_files=f'data/sp_input_mrci', save_files_in_current_directory=True, look_for_mocoef=True)
...
namd_kwargs = {
            'model': col,
            'model_predict_kwargs': {'level_of_theory': 'MRCI'},
            'time_step': time_step,
